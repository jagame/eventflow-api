...
public interface InboundStream<R> {
    ...
    default Stream<R> stream(boolean parallel) {
        return stream(InboundStream::next, parallel)
    ...
    default <U> Stream<U> stream(Function<? super InboundStream<R>, U> fetchMethod, boolean parallel) {
